...
function enviar_email($nova_senha, $destinatario) {
    ...
    $mail->Password = 'qyjz wyqp hugr jwbu'; // senha de app
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port = 587;

    $mail->setFrom('flp.lic23@uea.edu.br', 'FLP (Chat Local)');// email ultilizado para envio
...
$email = '';
$id = 'erro';
$html = file_get_contents('Visao/vEsquecelSenha.php');
